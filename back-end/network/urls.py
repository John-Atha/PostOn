...
urlpatterns = [
    ...
    path("Jwitter/api/postsmod", views.AllPostsMod, name="AllPostsMod"),
    ...
    path("Jwitter/api/followsmod", views.AllFollowsMod, name="AllFollowsMod"),
    path("Jwitter/api/follows/<int:id>", views.OneFollow, name="OneFollow"),
    path("Jwitter/api/followsmod/<int:id>", views.OneFollowMod, name="OneFollowMod"),
    path("Jwitter/api/likes", views.AllLikes, name="AllLikes"),
    path("Jwitter/api/likesmod", views.AllLikesMod, name="AllLikesMod"),
    path("Jwitter/api/likes/<int:id>", views.OneLike, name="OneLike"),
    path("Jwitter/api/likesmod/<int:id>", views.OneLikeMod, name="OneLikeMod"),
    path("Jwitter/api/comments", views.AllComments, name="allComments"),
    path("Jwitter/api/commentsmod", views.AllCommentsMod, name="allCommentsMod"),
    path("Jwitter/api/comments/<int:id>", views.OneComment, name="OneComment"),
    path("Jwitter/api/commentsmod/<int:id>", views.OneCommentMod, name="OneCommentMod"),
    ...
    path("Jwitter/api/likecommentsmod", views.AllLikeCommentsMod, name="AllLikeCommentsMod"),
    path("Jwitter/api/likecomments/<int:id>", views.OneLikeComment, name="OneLikeComment"),
    path("Jwitter/api/likecommentsmod/<int:id>", views.OneLikeCommentMod, name="OneLikeCommentMod"),
